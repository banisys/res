...
@section('content')
    ...
    <div class="container">
        <div class="row" style="border-bottom: 1px dashed #cccccc;padding-bottom: 10px;">
            <div class="col-md-3 ">
                <h3 id="title" style="margin: 0 0"><i class="icon-time" style="vertical-align: middle"></i>  اضافه کاری های {{$personel->name}}</h3>
            </div>
    ...
    <div class="container">
        <div class="row">
            <form class="form-horizontal tasi-form" method="post"
                  action="{{route('overtime.store',['id'=>$personel->id])}}" >
                {{csrf_field()}}
                <div class="row" style="margin-top:30px">
                    <div class="form-group" id="asd">
                        ...
                        <label class="control-label col-md-1 " for="time" id="zxc">ساعت :</label>
                        <div class="col-md-2 " id="qwe">
        ...
        <table class="table table-striped">
            ...
            @foreach($overtimes as $overtime)
                <tr>
                    ...
                    <td>{{$overtime->time}}</td>
                    <td>
                        <form action="{{route('overtime.destroy',['id'=>$overtime->id])}}" method="post">
                            {{ method_field('delete') }}
                            {{csrf_field()}}
...
<br><br><br>
    <div class="row">
        <div class="col-md-12" style="text-align: center">
            <span style="text-align: center;font-size:30px">آمار اضافه کاری ها</span><span
                    style="font-size:20px"> (ساعت) </span>
            <iframe style="border: none" src="{{route('statistics.chart.overtime',['id'=>$personel->id])}}" height="450px"
                    width="100%"></iframe>
        </div>
    </div>
