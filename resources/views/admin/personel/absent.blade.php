    ...
    <div class="container">
        <div class="row">
            <form class="form-horizontal tasi-form" method="post"
                  action="{{route('absent.store',['id'=>$personel->id])}}">
                {{csrf_field()}}
        ...
        <table class="table table-striped">
            ...
            @foreach($absents as $absent)
                <tr>
                    <td>{{$absent->date}}</td>
                    <td>
                        <form action="{{route('absent.destroy',['id'=>$absent->id])}}" method="post">
                            {{ method_field('delete') }}
                            {{csrf_field()}}
    ...
    <div class="container">
        <div class="row" style="border-bottom: 1px dashed #cccccc;padding-bottom: 10px;">
            <div class="col-md-12">
                ...
                <span style="font-size:25px;"> آمار غیبت ها </span>
            </div>
        </div>
        <br>
        <div class="row" style="border-bottom: 1px dashed #cccccc;padding-bottom: 10px;">
            ...
            <div class="col-md-11" style="margin-top:20px">
                ...
                text-align: center;border-radius:4px;margin-bottom:5px;
                    ...
                    <?php if ($farvardin->day == $x) {
                        echo "background-color:#ff6c60;color:#ffff";
                    } ?>
                    @endforeach
                            ">{{$x}}</span>
